...
class InfiniteSampler(Sampler):
    ...
    def __init__(
        ...
        """
        Args:
            size (int): Total number of data of the underlying dataset to sample from
            shuffle (bool, optional): Whether to shuffle the indices. Defaults to True.
            seed (Optional[int], optional): The initial seed of the shuffle. Must be the same
                                            across all workers. Defaults to 0.
