...
class YoloDetector:
    ...
    def _update_tracker(self, preds):
        ...
        for track in trackers:
            ...
            class_unique.update({class_name: class_unique_id + 1})
        ...
        tracker_df[["xmin", "ymin", "xmax", "ymax", "track_id", "class"]] = tracker_df[
            ["xmin", "ymin", "xmax", "ymax", "track_id", "class"]
    ...
    def _visualize(self, img, preds):
        ...
        for _, pred in preds.iterrows():
            ...
            v.draw_text(
                f"{pred['name']} {pred['class_unique_id']}",
                (pred["xmin"], max(0, pred["ymin"] - 14)),
                font_size=8,
                color="moccasin",
