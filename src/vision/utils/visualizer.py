...
from src.vision.v5.utils.plots import Colors
...
class Visualizer:
    ...
    def _create_text_labels(
        ...
        """Generate labels that classes and scores can match, and set class back to
        its original name if concrete class names are provided.
        """
        labels = None
