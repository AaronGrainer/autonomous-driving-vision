...
from src.vision.data.builtin_meta import COCO_CATEGORIES
...
@app.command()
def main(data_path="../coco128", split="train2017"):
    """Datasets converter from yolo to coco.

    Args:
        data_path (str, optional): Dataset root path. Defaults to "../coco128".
        split (str, optional): Dataset split part, optional [train2017, val2017].
            Defaults to "train2017".
    """
    converter = YOLO2COCO(data_path, split)
    converter.generate()
