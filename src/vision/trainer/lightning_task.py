...
import src.vision.models as models
from src.vision.data.coco_eval import COCOEvaluator
...
class DefaultTask(LightningModule):
    ...
    def forward(
        ...
        """This exists since PyTorchLightning forward are used for inference only
        (separate from ``training_step``). We keep ``targets`` here for Backward Compatible.
        """
